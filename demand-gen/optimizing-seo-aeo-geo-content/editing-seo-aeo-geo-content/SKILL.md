---
name: editing-seo-aeo-geo-content
...
Do NOT use when: there is no draft yet, the task is pure research, the user needs the full `optimizing-seo-aeo-geo-content` workflow, or the user needs final publication audit rather than editing.
...
| 1.0.1 | 2026-06-30 | Renamed to nested editing step under composite SEO/AEO/GEO content workflow |
